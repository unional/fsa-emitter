...
export function createEventAction<Input = undefined, Payload = undefined, Meta = undefined>(
	type: string,
	action: (input: Input) => (emit: (payload: Payload) => void) => void
): EventAction<Input, Payload, Meta> {
